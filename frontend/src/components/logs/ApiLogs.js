...
function ApiLogs() {
  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      const response = await api.get('/api/logs/api', { params });
  ...
  return (
    <div>
          ...
          <Grid item xs={12} sm={6} md={2}>
            <FormControl fullWidth size="small">
              ...
              >
                ...
                <MenuItem value="500">500 Internal Error</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={6} md={2}>
              ...
              {loading ? (
                ...
                logs.map((log) => (
                  <TableRow key={log.id} hover>
                    ...
                    <TableCell>
                      <Chip label={log.httpMethod} size="small" color="primary" variant="outlined" />
                    </TableCell>
                    <TableCell>
                      <Chip
      ...
      <Dialog open={openModal} onClose={() => setOpenModal(false)} maxWidth="md" fullWidth>
        <DialogTitle>API Log Detayı #{selectedLog?.id}</DialogTitle>
        <DialogContent>
          {selectedLog && (
            <Box sx={{ mt: 1 }}>
              <pre style={{
